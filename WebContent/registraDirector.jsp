...
<h1>Registra Director</h1>
	...
	<form action="registraDirector" id="id_form"> 
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" >Crea Director</button>
			</div>
	</form>
</div>

<script type="text/javascript">
	console.log("En carga grado");
	$.getJSON("cargaCombo",{"metodo":"grado"} ,function(data){
		console.log(data)
		$.each(data, function(i, x){
			$("#id_grado").append("<option value='"+ x.idGrado +"'>"+ x.nombre +"</option>");		
		});
	});
</script>
